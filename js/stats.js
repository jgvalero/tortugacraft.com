...
function drawLineChart(stat) {
  ...
  if (!isInitialized) {
    ...
    // Load data
    Promise.all([d3.json("data/week-01.json"), d3.json("data/week-02.json"), d3.json("data/week-03.json"), d3.json("data/week-04.json"), d3.json("data/week-05.json"), d3.json("data/week-06.json"), d3.json("data/week-07.json"), d3.json("data/week-08.json"), d3.json("data/week-09.json")]).then(function(files) {
      allData = [];
